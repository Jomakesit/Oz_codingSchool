...
Revision ID: d1e1cf851d9f
Revises: 
Create Date: 2026-06-05 18:02:55.973368
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.BigInteger(), autoincrement=True, nullable=False),
    sa.Column('record_id', sa.BigInteger(), nullable=False, comment='진료 기록 id'),
    # sa.Column('uploader_id', sa.BigInteger(), nullable=False, comment='X-ray 이미지를 업로드한 유저의 id'),
